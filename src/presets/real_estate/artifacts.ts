      ...
      const artifact: BenchmarkArtifact = {
        ...
        candidates: [
          ...
          },
          {
            ...
            category: "지역 부동산 중개",
            previewTone: "참고용 후보",
            description: "지역별 매물 탐색과 중개 정보 흐름을 참고할 수 있는 부동산 정보 서비스입니다.",
            whyUseful: "지역명, 매물 유형, 거래 조건을 중심으로 방문자를 빠르게 분류하는 방식을 참고할 수 있습니다.",
            strengths: ["지역 기반 탐색 흐름이 익숙함", "매물 조건 비교가 쉬움", "방문자의 검색 패턴과 잘 맞음"],
            weaknesses: ["브랜드 스토리와 전문 상담 메시지는 약할 수 있음", "고급스러운 첫인상은 별도 설계가 필요함"],
            borrow: ["지역별 매물 목록", "가격·면적 비교 패턴", "중개 문의 연결 구조"],
            fitScore: 86,
            websiteUrl: "https://www.neonet.co.kr",
          },
          {
            id: "zigbang-business",
            siteName: "직방",
